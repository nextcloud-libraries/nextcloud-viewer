...
import { ImageEditor as NcImageEditor } from '@nextcloud/image-editor'
...
const props = defineProps<{
	/** The image being edited, saved back over on export. */
	file: IFile
}>()
...
function onError(error: Error) {
	...
	showError(t('The image could not be edited.'))
}
</script>
